...
vars <- Args[1]
# TEST
# vars <- "/mnt/a/tcormier/testing/las_processing/Tiles_30m_las_RDATA/Cutzamala_Q2_391830_2122920_normFilMetrics_vars.RDATA"
load(vars)
print(ls.str())
...
if (calc.mets == 'Y') {
  ...
  #if lasdata is empty, stop with error
  if (nrow(lasdata)==0) {
    stop(paste0(las2mets.file, " has no data."))
  }
